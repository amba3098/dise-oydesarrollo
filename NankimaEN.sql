...
--
Drop DATABASE NankimaEN;
Create DATABASE NankimaEN;
Use NankimaEN;
...
INSERT INTO `categories` (`id`, `categories`, `date`) VALUES
...
INSERT INTO `customer` (`id`, `name`, `document`, `email`, `phone`, `address`, `birth_date`, `purchases`, `last_purchase`, `date`) VALUES
...
INSERT INTO `projects` (`id`, `id_categories`, `code`, `description`, `image`, `stock`, `purchase_price`, `sales_price`, `sales`, `date`) VALUES
...
INSERT INTO `sales` (`id`, `code`, `id_customer`, `id_seller`, `products`, `tax`, `neto`, `total`, `payment_method`, `date`) VALUES
